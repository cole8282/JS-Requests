...
function attachQuery() {
    axios.get('http://localhost:3000/query-test/?name=cole')
    .then(function(res) {
        console.log(res.data);
    })
}
...
queryBtn.addEventListener("click", attachQuery);
...
/*
    ...
    //console returned "You sent an empty query"
    2: Send more than 1 query on the URL -- what happened?
    //console returned 'You sent more than 1 query!'
*/
...
function createFood(event) {
    ...
    const foodInput = document.querySelector("#foody");
